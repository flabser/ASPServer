...
public class PersonSearchResult  implements java.io.Serializable {
    private kz.lof.webservices.store.ump.PersonShortData[] shortData;
    ...
    public PersonSearchResult(
           kz.lof.webservices.store.ump.PersonShortData[] shortData,
           int totalFound) {
    ...
    /**
     * Gets the shortData value for this PersonSearchResult.
     * 
     * @return shortData
     */
    public kz.lof.webservices.store.ump.PersonShortData[] getShortData() {
        return shortData;
    }


    /**
     * Sets the shortData value for this PersonSearchResult.
     * 
     * @param shortData
     */
    public void setShortData(kz.lof.webservices.store.ump.PersonShortData[] shortData) {
        this.shortData = shortData;
    }


    /**
     * Gets the totalFound value for this PersonSearchResult.
     * 
     * @return totalFound
     */
    ...
    /**
     * Sets the totalFound value for this PersonSearchResult.
     * 
     * @param totalFound
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PersonSearchResult)) return false;
        PersonSearchResult other = (PersonSearchResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PersonSearchResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://store.ump.webservices.lof.kz", "PersonSearchResult"));
