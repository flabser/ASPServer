...
public class StreetType  implements java.io.Serializable {
    ...
    /**
     * Gets the id value for this StreetType.
     * 
     * @return id
     */
    public int getId() {
    ...
    /**
     * Sets the id value for this StreetType.
     * 
     * @param id
     */
    ...
    /**
     * Gets the shortName value for this StreetType.
     * 
     * @return shortName
     */
    ...
    /**
     * Sets the shortName value for this StreetType.
     * 
     * @param shortName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://store.bti.webservices.lof.kz", "StreetType"));
