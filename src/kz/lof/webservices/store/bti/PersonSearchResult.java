...
public class PersonSearchResult  implements java.io.Serializable {
    private kz.lof.webservices.store.bti.PersonShortData[] shortData;
    ...
    public PersonSearchResult(
           kz.lof.webservices.store.bti.PersonShortData[] shortData,
           int totalFound) {
     ...
     * @return shortData
     */
    public kz.lof.webservices.store.bti.PersonShortData[] getShortData() {
        return shortData;
    }
     ...
     * @param shortData
     */
    public void setShortData(kz.lof.webservices.store.bti.PersonShortData[] shortData) {
        this.shortData = shortData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://store.bti.webservices.lof.kz", "PersonSearchResult"));
