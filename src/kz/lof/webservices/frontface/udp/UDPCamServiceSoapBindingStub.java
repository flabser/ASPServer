/**
 * UDPCamServiceSoapBindingStub.java
 *
...
public class UDPCamServiceSoapBindingStub extends org.apache.axis.client.Stub implements kz.lof.webservices.frontface.udp.UDPCamService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "birthDate"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "date"), java.util.Date.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://store.udp.webservices.lof.kz", "HumanShortData"));
        oper.setReturnClass(kz.lof.webservices.store.udp.HumanShortData.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "getAddressByFIOReturn"));
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "lang"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://store.udp.webservices.lof.kz", "TrustData"));
        oper.setReturnClass(kz.lof.webservices.store.udp.TrustData[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "getWarrByGRNZReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[2] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getFullDataByGRNZ");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "grnz"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "lang"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "getFullDataByGRNZReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[3] = oper;
    ...
    public UDPCamServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public UDPCamServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public UDPCamServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public kz.lof.webservices.store.udp.HumanShortData getAddressByFIO(java.lang.String firstName, java.lang.String lastName, java.lang.String middleName, java.util.Date birthDate, java.lang.String lang) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "getAddressByFIO"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {firstName, lastName, middleName, birthDate, lang});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (kz.lof.webservices.store.udp.HumanShortData) _resp;
            } catch (java.lang.Exception _exception) {
                return (kz.lof.webservices.store.udp.HumanShortData) org.apache.axis.utils.JavaUtils.convert(_resp, kz.lof.webservices.store.udp.HumanShortData.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public kz.lof.webservices.store.udp.TrustData[] getWarrByGRNZ(java.lang.String grnz, java.lang.String lang) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "getWarrByGRNZ"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {grnz, lang});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (kz.lof.webservices.store.udp.TrustData[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (kz.lof.webservices.store.udp.TrustData[]) org.apache.axis.utils.JavaUtils.convert(_resp, kz.lof.webservices.store.udp.TrustData[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public kz.lof.webservices.store.udp.VehicleFullData getFullDataByGRNZ(java.lang.String grnz, java.lang.String lang) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://udp.webservices.lof.kz", "getFullDataByGRNZ"));
