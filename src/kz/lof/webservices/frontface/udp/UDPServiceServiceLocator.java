...
public class UDPServiceServiceLocator extends org.apache.axis.client.Service implements kz.lof.webservices.frontface.udp.UDPServiceService {
    ...
    public kz.lof.webservices.frontface.udp.UDPService getUDPService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            kz.lof.webservices.frontface.udp.UDPServiceSoapBindingStub _stub = new kz.lof.webservices.frontface.udp.UDPServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (kz.lof.webservices.frontface.udp.UDPService.class.isAssignableFrom(serviceEndpointInterface)) {
                kz.lof.webservices.frontface.udp.UDPServiceSoapBindingStub _stub = new kz.lof.webservices.frontface.udp.UDPServiceSoapBindingStub(new java.net.URL(UDPService_address), this);
                _stub.setPortName(getUDPServiceWSDDServiceName());
                return _stub;
            }
        }
