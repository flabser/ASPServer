/**
 * QuestServiceSoapBindingStub.java
 *
...
public class QuestServiceSoapBindingStub extends org.apache.axis.client.Stub implements kz.lof.webservices.frontface.ump.QuestService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("searchPeople");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ump.webservices.lof.kz", "peopleList"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://store.ump.webservices.lof.kz", "WantedData"), kz.lof.webservices.store.ump.WantedData[].class, false, false);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://store.ump.webservices.lof.kz", "WantedResult"));
        oper.setReturnClass(kz.lof.webservices.store.ump.WantedResult.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://ump.webservices.lof.kz", "searchPeopleReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[1] = oper;
    ...
    public QuestServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public QuestServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public QuestServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://store.ump.webservices.lof.kz", "QuestData");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.ump.QuestData.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://store.ump.webservices.lof.kz", "WantedData");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.ump.WantedData.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://store.ump.webservices.lof.kz", "WantedResult");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.ump.WantedResult.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://ump.webservices.lof.kz", "ArrayOf_tns2_QuestData");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.ump.QuestData[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://store.ump.webservices.lof.kz", "QuestData");
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public kz.lof.webservices.store.ump.WantedResult searchPeople(kz.lof.webservices.store.ump.WantedData[] peopleList, int pageNum, int resultsOnPage, java.lang.String lang) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://ump.webservices.lof.kz", "searchPeople"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {peopleList, new java.lang.Integer(pageNum), new java.lang.Integer(resultsOnPage), lang});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (kz.lof.webservices.store.ump.WantedResult) _resp;
            } catch (java.lang.Exception _exception) {
                return (kz.lof.webservices.store.ump.WantedResult) org.apache.axis.utils.JavaUtils.convert(_resp, kz.lof.webservices.store.ump.WantedResult.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
