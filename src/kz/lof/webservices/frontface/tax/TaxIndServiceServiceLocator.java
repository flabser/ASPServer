...
public class TaxIndServiceServiceLocator extends org.apache.axis.client.Service implements kz.lof.webservices.frontface.tax.TaxIndServiceService {
    ...
    public kz.lof.webservices.frontface.tax.TaxIndService getTaxIndService() throws javax.xml.rpc.ServiceException {
    ...
    public kz.lof.webservices.frontface.tax.TaxIndService getTaxIndService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            kz.lof.webservices.frontface.tax.TaxIndServiceSoapBindingStub _stub = new kz.lof.webservices.frontface.tax.TaxIndServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (kz.lof.webservices.frontface.tax.TaxIndService.class.isAssignableFrom(serviceEndpointInterface)) {
                kz.lof.webservices.frontface.tax.TaxIndServiceSoapBindingStub _stub = new kz.lof.webservices.frontface.tax.TaxIndServiceSoapBindingStub(new java.net.URL(TaxIndService_address), this);
                _stub.setPortName(getTaxIndServiceWSDDServiceName());
                return _stub;
            }
        }
