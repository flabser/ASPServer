/**
 * TaxIndServiceSoapBindingStub.java
 *
...
public class TaxIndServiceSoapBindingStub extends org.apache.axis.client.Stub implements kz.lof.webservices.frontface.tax.TaxIndService {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tax.webservices.lof.kz", "indID"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"), long.class, false, false);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://store.tax.webservices.lof.kz", "TaxIndFullData"));
        oper.setReturnClass(kz.lof.webservices.store.tax.TaxIndFullData.class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tax.webservices.lof.kz", "lang"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://store.tax.webservices.lof.kz", "TaxIndSearchResult"));
        oper.setReturnClass(kz.lof.webservices.store.tax.TaxIndSearchResult.class);
    ...
    public TaxIndServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public TaxIndServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public TaxIndServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://store.tax.webservices.lof.kz", "TaxIndFullData");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.tax.TaxIndFullData.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://store.tax.webservices.lof.kz", "TaxIndSearchResult");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.tax.TaxIndSearchResult.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://store.tax.webservices.lof.kz", "TaxIndShortData");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.tax.TaxIndShortData.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://store.tax.webservices.lof.kz", "TaxOffice");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.tax.TaxOffice.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://tax.webservices.lof.kz", "ArrayOf_tns1_InfoEntry");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.common.InfoEntry[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://common.webservices.lof.kz", "InfoEntry");
            ...
            qName = new javax.xml.namespace.QName("http://tax.webservices.lof.kz", "ArrayOf_tns2_TaxIndShortData");
            cachedSerQNames.add(qName);
            cls = kz.lof.webservices.store.tax.TaxIndShortData[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://store.tax.webservices.lof.kz", "TaxIndShortData");
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public kz.lof.webservices.store.tax.TaxIndFullData getFullData(long indID, java.lang.String lang) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(indID), lang});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (kz.lof.webservices.store.tax.TaxIndFullData) _resp;
            } catch (java.lang.Exception _exception) {
                return (kz.lof.webservices.store.tax.TaxIndFullData) org.apache.axis.utils.JavaUtils.convert(_resp, kz.lof.webservices.store.tax.TaxIndFullData.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {lastName, firstName, middleName, new java.lang.Integer(pageNum), new java.lang.Integer(resultsOnPage), lang});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (kz.lof.webservices.store.tax.TaxIndSearchResult) _resp;
            } catch (java.lang.Exception _exception) {
                return (kz.lof.webservices.store.tax.TaxIndSearchResult) org.apache.axis.utils.JavaUtils.convert(_resp, kz.lof.webservices.store.tax.TaxIndSearchResult.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
