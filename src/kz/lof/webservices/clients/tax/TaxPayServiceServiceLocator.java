...
public class TaxPayServiceServiceLocator extends org.apache.axis.client.Service implements kz.lof.webservices.clients.tax.TaxPayServiceService {
	...
	private java.lang.String TaxPayService_address = "http://" + Environment.getExtHost("nk") + "/WS/services/TaxPayService";
	...
	public kz.lof.webservices.clients.tax.TaxPayService getTaxPayService() throws javax.xml.rpc.ServiceException {
		...
		kz.lof.webservices.clients.tax.TaxPayService svc = getTaxPayService(endpoint);
		((Stub)svc).setUsername("temp_user");
		((Stub)svc).setPassword("temp_password");
		return svc;
	}
	...
	public kz.lof.webservices.clients.tax.TaxPayService getTaxPayService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			kz.lof.webservices.clients.tax.TaxPayServiceSoapBindingStub _stub = new kz.lof.webservices.clients.tax.TaxPayServiceSoapBindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (kz.lof.webservices.clients.tax.TaxPayService.class.isAssignableFrom(serviceEndpointInterface)) {
				kz.lof.webservices.clients.tax.TaxPayServiceSoapBindingStub _stub = new kz.lof.webservices.clients.tax.TaxPayServiceSoapBindingStub(new java.net.URL(TaxPayService_address), this);
				_stub.setPortName(getTaxPayServiceWSDDServiceName());
				return _stub;
			}
		}
