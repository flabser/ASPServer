...
public class ForeignersSearchServiceServiceLocator extends org.apache.axis.client.Service implements kz.lof.webservices.clients.ump.ForeignersSearchServiceService {
	...
	private java.lang.String ForeignersSearchService_address = "http://" + Environment.getExtHost("ump") + "/WS/services/ForeignersSearchService";
	...
	public kz.lof.webservices.clients.ump.ForeignersSearchService getForeignersSearchService() throws javax.xml.rpc.ServiceException {
		...
		kz.lof.webservices.clients.ump.ForeignersSearchService fss = getForeignersSearchService(endpoint);
		((Stub)fss).setUsername("temp_user");
		((Stub)fss).setPassword("temp_password");
		return fss;
	}

	public kz.lof.webservices.clients.ump.ForeignersSearchService getForeignersSearchService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			kz.lof.webservices.clients.ump.ForeignersSearchServiceSoapBindingStub _stub = new kz.lof.webservices.clients.ump.ForeignersSearchServiceSoapBindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (kz.lof.webservices.clients.ump.ForeignersSearchService.class.isAssignableFrom(serviceEndpointInterface)) {
				kz.lof.webservices.clients.ump.ForeignersSearchServiceSoapBindingStub _stub = new kz.lof.webservices.clients.ump.ForeignersSearchServiceSoapBindingStub(new java.net.URL(ForeignersSearchService_address), this);
				_stub.setPortName(getForeignersSearchServiceWSDDServiceName());
				return _stub;
			}
		}
