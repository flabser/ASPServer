...
public class HumansSearchServiceProxy implements kz.lof.webservices.clients.ump.HumansSearchService {
  ...
  public kz.lof.webservices.store.ump.HumansSearchResult getHumanByAddr(kz.lof.webservices.store.ump.Street street, java.lang.String house, java.lang.String flat, String flatPart, int pageNum, int resultsOnPage, java.lang.String lang) throws java.rmi.RemoteException{
    if (humansSearchService == null)
      _initHumansSearchServiceProxy();
