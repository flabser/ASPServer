...
//	private static ForeignersSearchServiceProxy  fSSProxy;
//	private static QuestServiceProxy qSProxy;
...
////			testHSSServiceGetStreets("���","RUS");
////			testHSSServiceGetDistricts("���","RUS");
////			testHSSServiceGetCountry("���","RUS");
////
...
//		outln("  Method: HumansSearchService -> getHumanByAddr");
//		outln("    Parameters:");
//		outln("      street = " + street);
//		outln("      house = " + house);
//		outln("      flat = " + flat);
...
//		outln("  Method: HumansSearchService -> getDataByFIO");
//		outln("    Parameters:");
//		outln("      lastName = " + lastName);
//		outln("      firstName = " + firstName);
//		outln("      middleName = " + middleName);
