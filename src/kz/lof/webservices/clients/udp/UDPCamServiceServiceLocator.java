...
public class UDPCamServiceServiceLocator extends org.apache.axis.client.Service implements kz.lof.webservices.clients.udp.UDPCamServiceService {
	...
	public kz.lof.webservices.clients.udp.UDPCamService getUDPCamService() throws javax.xml.rpc.ServiceException {
		...
		kz.lof.webservices.clients.udp.UDPCamService udpCamService = getUDPCamService(endpoint);
		((Stub)udpCamService).setUsername("temp_user");
		((Stub)udpCamService).setPassword("temp_password");
	...
	public kz.lof.webservices.clients.udp.UDPCamService getUDPCamService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			kz.lof.webservices.clients.udp.UDPCamServiceSoapBindingStub _stub = new kz.lof.webservices.clients.udp.UDPCamServiceSoapBindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (kz.lof.webservices.clients.udp.UDPCamService.class.isAssignableFrom(serviceEndpointInterface)) {
				kz.lof.webservices.clients.udp.UDPCamServiceSoapBindingStub _stub = new kz.lof.webservices.clients.udp.UDPCamServiceSoapBindingStub(new java.net.URL(UDPCamService_address), this);
				_stub.setPortName(getUDPCamServiceWSDDServiceName());
				return _stub;
			}
		}
