...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="filename" select="document/fields/pdocrtfcontent"/>
		<html>
			<head>
				<title>
					<xsl:value-of select="concat(document/captions/eis/@caption,' - ',document/captions/podtipdocumenta/@caption)"/>
				</title>
					...
					<div class="formwrapper">
						<div class="formtitle">
							<div style="float:left" class="title">
								<xsl:value-of select="document/captions/podtipdocumenta/@caption"/>
							</div>
						</div>	
						...
						<div id="tabs">
							...
							<div class="ui-tabs-panel" id="tabs-1">
								...
								<input type="hidden" name="type" value="save"/>
									<input type="hidden" name="id" value="subtypedoc"/>		
