...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="request">
		...
		<html>
	  		<head>
	 			<title>
	 				<xsl:value-of select="concat(document/captions/eis/@caption,' - ',document/captions/employer/@caption,': ', document/fields/fullname)"/>
	 			</title>
	    	...
	    	<body>  
	    		<div id="docwrapper">
					...
					<div class="formwrapper">
	            		<div  class="formtitle">
							<div class="title">
								<font><xsl:value-of select="document/captions/employer/@caption"/> - <xsl:value-of select="document/fields/shortname"/></font>
							</div>
						</div>
