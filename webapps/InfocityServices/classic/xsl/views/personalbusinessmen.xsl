					...
					<div id="viewtablediv">
						<div id="tablecontent">
							<div id="fieldsdiv" style="margin-right:16px">
								...
								<br/>
								<br/>
							<xsl:if test="/request/@id='personalbusinessmen' or /request/@id='personalbusinessmen-fio' ">
								<script type="text/javascript">
					   					$(document).ready(function(){
								...
								<table id="inputstable" style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									...
									<tr>
										...
										<td style="font-size:16px; text-align:right;"><br/>
												...
												<xsl:attribute name="onclick">javascript:Tax_getDataByFIO(1)</xsl:attribute>
							...
							<xsl:if test="/request/@id='personalbusinessmen-rnn'">
							<script type="text/javascript">
					   					$(document).ready(function(){
								...
								<table id="inputstable" style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									...
									<tr>
										...
										<td style="font-size:16px; text-align:right;">
											<br/>
												<button class="button" id="sendrequest" style='margin-left:3px'>
												<xsl:attribute name="onclick">javascript:Tax_getDataByRNN()</xsl:attribute>
												<xsl:value-of select="columns/column[@id='VYPOLNIT']/@caption"/>
											</button>
										</td>
									</tr>
							...
							<table id="resultHeaderDataTable" style="border-collapse:collapse; font-size:14px;  width:100%; min-width:847px">
								<tr style="height:40px; background:#efefef">
									...
									<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:14%;" id="2td"><xsl:value-of select="columns/column[@id='NAIMENOVANIE']/@caption"/></td>
									<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:12%;" id="3td"><xsl:value-of select="columns/column[@id='RNN']/@caption"/></td>
									<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:16%;" id="4td"><xsl:value-of select="columns/column[@id='IIN']/@caption"/></td>
									<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:18%;" id="5td"><xsl:value-of select="columns/column[@id='FIO']/@caption"/></td>
									<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:16%;" id="6td"><xsl:value-of select="columns/column[@id='VIDPREDPRINIMATELSTVA']/@caption"/></td>
								</tr>
							</table>
							</div>
