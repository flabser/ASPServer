					...
					<div id="viewtablediv">
						<div id="tablecontent">
							<div id="fieldsdiv" style="margin-right:16px">
								...
								<br/>
								<br/>
								<xsl:if test="/request/@id='socialdept-fio'">
									<script type="text/javascript">
					   					$(document).ready(function(){
										...
										<tr>
											...
											<td style="font-size:16px; text-align:right;"><br/>
												<button class="button" id="sendrequest" style='margin-left:3px'>
													<xsl:attribute name="onclick">javascript:Social_getDataByFIO(1,1)</xsl:attribute>
								...
								<xsl:if test="/request/@id='socialdept-address'">
									<script type="text/javascript">
								   					$(document).ready(function(){
												...
												<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
													<tr>
														<td style="font-size:15px; text-align:right; width:250px">
													...
													<tr>
														...
														<td style="font-size:16px; text-align:right;"><br/>
															<button class="button" id="sendrequest" style='margin-left:3px'>
																<xsl:attribute name="onclick">javascript:Social_getDataByAddr("1")</xsl:attribute>
																<xsl:value-of select="columns/column[@id='VYPOLNIT']/@caption"/>
															</button>
														</td>
													</tr>
								...
								<xsl:if test="/request/@id='socialdept-district'">
									<script type="text/javascript">
					   					$(document).ready(function(){
									...
									<table id="inputstable" style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
										<tr>
											<td width="250px" style="font-size:15px; text-align:right;">
												<xsl:value-of select="columns/column[@id='DISTRICT']/@caption"/> :
											</td>
											<td width="300px">
												<select name="district" style="width:300px; height:25px" class="inputrequest">
										...
										<tr>
											...
											<td style="font-size:16px; text-align:right;"><br/>
												<button class="button" id="sendrequest" style='margin-left:3px'>
													<xsl:attribute name="onclick">javascript:Social_getDataByDistrict('1')</xsl:attribute>
													<xsl:value-of select="columns/column[@id='VYPOLNIT']/@caption"/>
												</button>
											</td>
										</tr>
							...
							<table id="resultHeaderDataTable" style="border-collapse:collapse; font-size:14px;  width:100%; min-width:847px">
								<tr style="height:40px; background:#efefef">
									...
									<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:14%" id="3td">
										<xsl:value-of select="columns/column[@id='ADDRESS']/@caption"/>
									</td>
								</tr>
							</table>
						</div>
