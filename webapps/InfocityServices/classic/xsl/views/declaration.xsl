				...
				<div id="wrapper">
					...
					<div id="viewtablediv">
						<div id="tablecontent">
							...
							<br/>
							<xsl:if test="/request/@id='declaration' or /request/@id='declaration-number'">
							...
							<xsl:if test="/request/@id='declaration-rnn'">
								<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
											<xsl:value-of select="columns/column[@id='NOMERRNN']/@caption"/> :
										</td>
										<td width="300px">
											<input type="text" style="width:300px; padding:2px;" class="inputrequest"/>
										</td>
							...
							<xsl:if test="/request/@id='declaration-period'">
								<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
											<xsl:value-of select="columns/column[@id='S']/@caption"/> :
										</td>
										<td width="300px">
											<input type="text" style="width:300px; padding:2px;" class="inputrequest"/>
										</td>
									...
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
											<xsl:value-of select="columns/column[@id='PO']/@caption"/> :
										</td>
										<td width="300px">
											<input type="text" style="width:300px; padding:2px;" class="inputrequest"/>
										</td>
							...
							<div style="overflow:auto;">
								<table style="width:100%;border-collapse:collapse; font-size:14px">
									<tr style="height:40px; background:#efefef">
										...
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='FAMILIYA']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='IMYA']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='OTCHESTVO']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='IIN']/@caption"/></td>
										...
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='ADRESPROZHIVANIYA']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='TELEPHON']/@caption"/></td>
									</tr>
