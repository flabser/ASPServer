				...
				<div id="wrapper">
					...
					<div id="viewtablediv">
						<div id="tablecontent">
							...
							<br/>
							<br/>
							<xsl:if test="/request/@id='landlots-organization' or /request/@id='landlots'">
								<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
											<xsl:value-of select="columns/column[@id='FRAGMENTNAIMENOVANIYA']/@caption"/> :
										</td>
										<td width="300px">
									...
									<tr>
										...
										<td style="font-size:16px; text-align:right;">
											<br/>
											<button class="button" id="sendrequest">
							...
							<xsl:if test="/request/@id='landlots-kadastr-number'">
								<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
											<xsl:value-of select="columns/column[@id='NOMERUCHASTKA']/@caption"/> :
										</td>
										<td width="500px">
											<input type="text" style="width:300px; padding:2px;" class="inputrequest"/>
										</td>
									...
									<tr>
										...
										<td style="font-size:16px; text-align:right;">
											<br/>
											<button class="button" type="button" onclick="javascript:formKadastrNumber()">
												<xsl:value-of select="columns/column[@id='SFORMIROVATNOMER']/@caption"/>
											</button>
											<button class="button" id="sendrequest">
												<xsl:value-of select="columns/column[@id='VYPOLNIT']/@caption"/>
											</button>
							...
							<xsl:if test="/request/@id='landlots-fio'">
								<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
										...
										<td width="300px">
											<input type="text" style="width:300px; padding:2px;"/>
										</td>
									</tr>
									<tr>
							...
							<xsl:if test="/request/@id='landlots-dok-uchastok'">
								<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
										...
										<td width="300px">
											<select name="type" style="width:300px">
												<xsl:for-each select="glossaries/typedoczem/query/entry">
													<option value="{@docid}">
							...
							<div style="overflow:auto;">
								<table style="width:100%;border-collapse:collapse; font-size:14px">
									<tr style="height:40px; background:#efefef">
										...
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='NAZVANIE']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='CELEVOENAZNACHENIE']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='FIONAIMENOVANIEORGANIZACII']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='DATAROZHDENIYA']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='RAION']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='KVARTAL']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='ULICA']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='NOMERZDANIYAKORPUS']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='TIPPRAVA']/@caption"/></td>
									</tr>
