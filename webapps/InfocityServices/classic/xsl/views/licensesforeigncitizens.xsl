				...
				<div id="wrapper">
					...
					<div id="viewtablediv">
						<div id="tablecontent">
							...
							<br/>
							<xsl:if test="/request/@id='licensesforeigncitizens' or /request/@id='licensesforeigncitizens-fio'">
							...
							<xsl:if test="/request/@id='licensesforeigncitizens-id'">
								<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
											<xsl:value-of select="columns/column[@id='NOMERUDOSTLICHNOSTI']/@caption"/> :
										</td>
										<td width="300px">
											<input type="text" style="width:300px; padding:2px;" class="inputrequest"/>
										</td>
							...
							<xsl:if test="/request/@id='licensesforeigncitizens-organization'">
								<table style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
