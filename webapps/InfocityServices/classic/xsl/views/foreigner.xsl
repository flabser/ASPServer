				...
				<div id="wrapper">
					...
					<div id="viewtablediv">
						<div id="tablecontent">
							...
							<br/>
							<br/>
							<xsl:if test="/request/@id='foreigner' or /request/@id='foreigner-fio'">
								<script type="text/javascript">
					   					$(document).ready(function(){
									...
									<tr>
										...
										<td style="font-size:16px; text-align:right;"><br/>
											<button class="button" id="sendrequest" style='margin-left:3px'>
												<xsl:attribute name="onclick">javascript:UMP_getDataByFIO(2,1)</xsl:attribute>
							...
							<xsl:if test="/request/@id='foreigner-addr'">
								<script type="text/javascript">
					   					$(document).ready(function(){
								...
								<table id="inputstable" style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
										...
										<td width="300px">
											<input type="text" style="width:300px; padding:2px;" name="street" class="inputrequest"/>
										</td>
									</tr>
									<tr>
										<td width="250px" style="font-size:15px; text-align:right;">
									...
									<tr>
										...
										<td style="font-size:16px; text-align:right;">
											<br/>
											<button class="button" id="sendrequest" style='margin-left:3px'>
												<xsl:attribute name="onclick">javascript:UMP_getDataByAddr(2,1)</xsl:attribute>
												<xsl:value-of select="columns/column[@id='VYPOLNIT']/@caption"/>
											</button>
										</td>
									</tr>
							...
							<xsl:if test="/request/@id='foreigner-passport'">
								<script type="text/javascript">
					   					$(document).ready(function(){
					   						loadprevparamreq($.cookie('lastreqview'), 'passport')
										})
									</script>
								<table id="inputstable" style="border-collapse:collapse;  font-family:Verdana,Arial,Helvetica,sans-serif !important; color:#111; margin: 45px 0px 10px;">
									<tr>
									...
									<tr>
										...
										<td width="300px">
											<input type="text" style="width:300px; padding:2px;" name="serial" class="inputrequest"/>
										</td>
									</tr>
									<tr>
										<td style="padding:3px; text-align:left"></td>
										<td style="font-size:16px; text-align:right;"><br/>
											<button class="button" id="sendrequest" style='margin-left:3px'>
												<xsl:attribute name="onclick">javascript:UMP_getDataByID(2,1)</xsl:attribute>
												<xsl:value-of select="columns/column[@id='VYPOLNIT']/@caption"/>
											</button>
										</td>
									</tr>
							...
							<div style="height:35px; text-align:center; width:100%; font-size:12px; color:#444">
								...
								<table id="resultHeaderDataTable" style="border-collapse:collapse; font-size:14px;  width:100%; min-width:847px">
									<tr style="height:40px; background:#efefef">
										...
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:23%" id="2td">
										...
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:14%" id="4td">
											<xsl:value-of select="columns/column[@id='DOCUMENTNUMBER']/@caption"/>
										</td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:13%" id="5td">
											<xsl:value-of select="columns/column[@id='DOCUMENTSERIAL']/@caption"/>
										</td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:16%" id="6td">
											<xsl:value-of select="columns/column[@id='POL']/@caption"/>
										</td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:12%" id="7td">
											<xsl:value-of select="columns/column[@id='NACIONALNOST']/@caption"/>
										</td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:18%" id="8td">
											<xsl:value-of select="columns/column[@id='STRANAGRAZHDANSTVA']/@caption"/>
										</td>
									</tr>
								</table>
						</div>
