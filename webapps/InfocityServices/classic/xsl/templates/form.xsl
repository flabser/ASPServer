...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="cssandjs">
		...
		<link type="text/css" rel="stylesheet" href="classic/css/form.css" media="screen"/>
		<link type="text/css" rel="stylesheet" href="classic/css/actionbar.css" media="screen"/>
		<link type="text/css" rel="stylesheet" href="classic/css/dialogs.css" media="screen"/>
		<link type="text/css" rel="stylesheet" href="classic/css/print_forms.css" media="print"/>
		<link rel="Stylesheet" type="text/css" href="/SharedResources/jquery/js/jhtmlarea/style/jHtmlArea.css" media="screen"/>
	...
	<xsl:template name="documentheader">
		<div id="header-view">
			<span style="float:left">
				...
				<xsl:variable name='ecr' select="replace(//captions/eis/@caption,$simbol ,'&quot;')"/>
				<font style="font-size:1.3em; vertical-align:27px; color:#555555">
					<xsl:value-of select="$ecr"/>
				</font>
			</span>
			<span style="float:right; padding:5px 5px 5px 0px" id="usernavpanel">
				...
				<a target="_parent" id="helpbtn" href="Provider?type=static&amp;id=help_summary" title="Помощь" style="text-decoration:none;color: #555555 ; font: 11px Tahoma; font-weight:bold">
					<font style="margin-left:15px;">Помощь</font> 
				</a>
			</span>				
		</div>
	</xsl:template>
	
	<xsl:template name="documentheader2">
		<div id="header-view">
			<span style="float:left">
				<img alt="" src ="classic/img/Logo_CIS_small.png" style="margin:5px; width:130px"/>
				<font style="font-size:1.3em; vertical-align:27px; color:#555555">Единая Информационная система "Город"</font>
			</span>
