						...
						<div class="button_panel" style="margin-top:8px">
							...
							<span style="float:left; margin-left:3px; margin-top:2px">
								<button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="canceldoc">
									<xsl:attribute name="onclick">javascript:CancelForm(&quot;<xsl:value-of select="/request/history/entry[@type = 'view'][last()]"/>&amp;page=<xsl:value-of select="document/@openfrompage"/>&quot;,&quot;<xsl:value-of select="document/fields/grandparform"/>&quot;)</xsl:attribute>
									<span>
