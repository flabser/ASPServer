						...
						<div id="tablecontent">
							...
							<div style="overflow:auto;">
								<div>
									...
									<select id="server" onchange="javascript:selectServerLog(this)" style="padding:3px; width: 130px; vertical-align:bottom">
										<option value="">
										</option>
									...
									<select id="service" style="padding:3px; width: 130px; vertical-align:bottom">
										<option value="">
										</option>
									...
									<font style="font-size:13px; margin-left:10px"><xsl:value-of select="columns/column[@id = 'DATEFROM']/@caption"/> : </font>
									<input type="text" id="datefrom" class="required" style="padding:3px; width: 80px; vertical-align:bottom"/>
									<font style="font-size:13px; margin-left:10px"><xsl:value-of select="columns/column[@id = 'DATETO']/@caption"/> : </font>
									<input type="text" id="dateto" class="required" style="padding:3px; width: 80px; vertical-align:bottom"/>
									<button class="button" style="margin-left:5px">
										<xsl:attribute name="onclick">javascript:getReportServices();</xsl:attribute>
										Сформировать отчет
									</button>
								</div>
