					...
					<div id="viewtablediv">
						<div id="tablecontent">
							...
							<div style="overflow:auto;">
								<div>
									<font style="font-size:13px">ID пользователя : </font>
									<input  type="text" id="userid" class="required" style="padding:3px; width: 120px; vertical-align:bottom"/>
									...
									<button class="button" style="margin-left:5px">
										<xsl:attribute name="onclick">javascript:getReportWorkUsers();</xsl:attribute>
										Сформировать отчет
									</button>
								</div>
