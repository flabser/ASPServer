					...
					<div id="viewtablediv">
						<div id="tablecontent">
							...
							<div style="overflow:auto;">
								<div id="tablecontent-for-structurelist" style="margin-top:20px">
								<table style="width:100%;border-collapse:collapse; font-size:14px; margin-top:10px">
									<tr style="height:40px; background:#efefef">
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:270px "><xsl:value-of select="columns/column[@id='SERVERISTOCHNIK']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:200px"><xsl:value-of select="columns/column[@id='IDENTIFIKATORVSETI']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:150px"><xsl:value-of select="columns/column[@id='SOSTOYANIE']/@caption"/></td>
										<td style="border:1px solid #ccc; text-align:center; font-weight:bold; width:180px"><xsl:value-of select="columns/column[@id='PRIMECHANIE']/@caption"/></td>
									</tr>
									<xsl:for-each select="glossaries/typeservices/entry">
										 <tr style="color:#444444" id="{name}">
											<td style="text-align:left; border:1px solid #ccc; height:25px; padding-left:10px" >
												<xsl:value-of select="namerus"/>
											</td>
											<td style="text-align:left; border:1px solid #ccc; height:25px; padding-left:10px">
												<xsl:value-of select="name"/>
											</td>
											<td style="text-align:center; border:1px solid #ccc; height:25px; padding-left:10px">
												<script>
													$(function() {
														checkservers("<xsl:value-of select='name'/>")
						        					});
												</script>
											</td>
											<td style="text-align:left; border:1px solid #ccc; height:25px; padding-left:10px">
