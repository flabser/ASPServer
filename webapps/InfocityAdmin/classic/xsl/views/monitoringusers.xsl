							...
							<div style="overflow:auto;">
								<table style="width:100%;border-collapse:collapse; font-size:14px; margin-top:30px; margin-right:20px">
									<tr style="height:40px; background:#efefef; border:1px solid #ccc;">
										...
										<td style="text-align:center; font-weight:bold; width:250px "><xsl:value-of select="columns/column[@id='DATE']/@caption"/>Дата</td>
										<td style="text-align:center; font-weight:bold;  width:280px"><xsl:value-of select="columns/column[@id='USER']/@caption"/>Пользователь</td>
										<td style="text-align:center; font-weight:bold;  min-width:200px"><xsl:value-of select="columns/column[@id='TYPE']/@caption"/>Тип</td>
									</tr>
								</table>
								<div style="position:absolute; top:174px; bottom:0px; overflow-y:scroll; width:100%">
									<table class="viewtable" style="width:100%;border-collapse:collapse; font-size:12px;">
										<xsl:for-each select="query/entry">
											 <tr style="height:30px;">
												...
												<td nowrap="nowrap" style="border:1px solid #ccc; text-align:left;  width:250px">
													<div style="display:block; overflow:hidden; width:93%;">&#xA0;
															<xsl:value-of select="@eventtime"/>
													</div>
												</td>
												<td nowrap="nowrap" style="border:1px solid #ccc; text-align:left;  width:280px">
													<div style="display:block; overflow:hidden; width:93%;">&#xA0;
