					...
					<div id="viewtablediv">
						<div id="tablecontent">
							...
							<div style="overflow:auto;">
									<div id="tablecontent-for-structurelist" style="margin-top:30px">
										<div>
											<xsl:for-each select="glossaries/typeservices/entry">
												<font style="font-family:Verdana,Arial,Helvetica,sans-serif; font-size:0.95em">
													<xsl:value-of select="namerus"/>	
												</font>
												<table id="viewtable" style="border-collapse:collapse; border:0;">
													<!-- <xsl:apply-templates select="services"/> -->
													<xsl:for-each select="services/entry">
														<tr>
															<td style="padding-left:20px;height:20px">
																<font style="font-family:Verdana,Arial,Helvetica,sans-serif; font-size:0.85em">
																	<xsl:value-of select="viewtext"/>
																</font>
																<table>
																	<xsl:for-each select="methods/entry">
																		<tr>
																			<td style="padding-left:20px;height:20px">
																				<font style="font-family:Verdana,Arial,Helvetica,sans-serif; font-size:0.8em">
																					<a  href="" style="font-style:arial; font-size:12px; margin:0px 2px;" class="doclink">
																						<xsl:attribute name="href">Provider?type=page&amp;id=reportstatisticsservices&amp;element=document&amp;userid=<xsl:value-of select="value"/>&amp;key=&amp;page=1</xsl:attribute>
																						<xsl:attribute name="onclick">javascript:addNameToCookies("<xsl:value-of select='value'/>")</xsl:attribute>
