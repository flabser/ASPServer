...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request/content">
		<html>
			<head>
				<title>Администратор ЕИС "Город"</title>
				...
				<div id="wrapper">
					...
					<div id="footer">
						<span style=" float:left; margin-left:5px">
							<font style="vertical-align:5px">Администратор ЕИС "Город"  </font>
					...
					<!-- <div id="answerform" style="position:absolute; width:500px ; height:250px; top:30%; left:30%; border:1px solid #6790B3; background:white; display:none">
						<form action="Login" method="post" id="ans" name="ans" style="float:left; width:100%">
						<div style="margin-top:20px; text-align:center"><font style="font-size:18px">Авторизация: шаг 2</font></div>
						<table style="margin-top:45px">
							...
							<tr>
								...
								<td>
									<input type="text" name="answer" value="" id="answer" style="width:185px; margin-top:7px; height: 16px; padding: 3px 3px 3px 5px;"/>
								</td>
							</tr>
							<tr>
								<td style="width:200px;">
								...
								<td style="padding-top:8px">
									<button type="button">
										<xsl:attribute name="onclick">javascript:submitAnswerForm()</xsl:attribute>												
										<font class="button" style="margin-right:5; font-family:verdana; vertical-align:3px; font-size:10pt">Отправить</font>	
									</button>
									<button type="button">
										<xsl:attribute name="onclick">javascript:$("#answerform").css("display","none"); $("#answer").val("")</xsl:attribute>												
										<font class="button" style="margin-right:5; font-family:verdana; vertical-align:3px; font-size:10pt">Отмена</font>	
									</button>	
								</td>
							</tr>
						</table>
